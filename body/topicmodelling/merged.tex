...
\begin{figure}
    \centering
    \includegraphics{pictures/topic/merged/pvaluescrosstopic.png}
    \caption{Caption}
...
\begin{figure}
    \centering
    \includegraphics{pictures/topic/merged/pvaluecategories.pdf}
    \caption{Caption}
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=0.8\linewidth]{pictures/topic/merged/DAVID_blood.pdf}
    \caption{Caption}
