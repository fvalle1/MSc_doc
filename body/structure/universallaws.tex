...
\begin{figure}[htb!]
    ...
    \label{fig:my_label}
\end{figure}
Not surprisingly in the GTEx dataset it is retrieved the same behaviour at this time. The power law is found and considering non coding genes lead to a knee in the power law.
