...
\definecolor{pythoncyan}{RGB}{0,255,255}
...
\input{head/frontPage-cr_eng.tex}
...
\input{body/scalinglaws.tex}

\input{body/topicmodelling.tex}

\input{body/conclusions.tex}

%%APPENDIXES
\input{appendix/appAltmann}
\input{appendix/vmeasure}
